...
*p.s. 距离我第一次发布这个插件已经快3年了，我自己不用思源也已经2年多了。本来想着这个插件就这样搁置吧，但是issue区陆陆续续有用户提问题，还是决定继续维护一下。昨天用AI一次发了好几个版，但没有实际测试，结果越来越乱，今天干脆抽时间重新装了思源实际调试，至少我自己测试没什么大问题了。对更新了2.0.3-2.0.X版本的用户说声抱歉，你可以使用插件按钮右键清理序号后重新生成。*

*也没想到这个插件居然已经5000多下载，后续如果有问题可以继续提issue，严重问题我会尽快处理的。*

*另外，自荐一个还在开发阶段的笔记应用：[SecondLoop](https://github.com/dale0525/SecondLoop)，如果你也不想辛辛苦苦整理笔记，去考虑什么打标签啊双链啊，希望可以想到什么写什么、以后随时能够检索历史信息、充分利用AI能力，可以关注一下。*
